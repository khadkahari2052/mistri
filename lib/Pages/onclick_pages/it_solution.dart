...
class ITSolution extends StatefulWidget {
  const ITSolution({ Key? key }) : super(key: key);

  @override
  State<ITSolution> createState() => _ITSolutionState();
}

class _ITSolutionState extends State<ITSolution> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
         backgroundColor: Color.fromARGB(255, 27, 78, 119),
        title: Text("ITSolution"),
      ),
